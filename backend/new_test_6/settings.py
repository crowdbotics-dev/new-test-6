"""
Django settings for new_test_6 project.
...
WSGI_APPLICATION = 'new_test_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_test_6 API",
    "DESCRIPTION": "API documentation for new_test_6 App",
    "VERSION": "v1",
}
